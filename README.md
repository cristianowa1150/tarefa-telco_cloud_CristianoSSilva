...
# 📤 Subindo o projeto para o GitHub (passo a passo)
...
### 2️⃣ Configurar Git (uma única vez)
...
### 3️⃣ Inicializar o repositório

Dentro da pasta `open5gs-docker`:
...
### 5️⃣ Criar o primeiro commit

```bash
git commit -m "Implantação do Core 5G Open5GS com Docker"
```
...
* Nome: `open5gs-docker`
* Não marque README (já temos)

---

### 7️⃣ Conectar com o GitHub

(Substitua a URL pelo seu repositório)

```bash
git branch -M main
git remote add origin https://github.com/SEU_USUARIO/open5gs-docker.git
```
...
Este repositório demonstra, de forma **simples e didática**, a implantação de um **Core 5G cloud-native** usando Docker.

Mesmo sem conhecimento prévio em Linux, é possível reproduzir o laboratório seguindo este guia.
